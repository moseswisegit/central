...
return [
	...
	'produits' => [
		...
		'fields' => [
			'libelle' => 'Designation',
			'qte_command' => 'Quantité commandée',
			'qte_recu' => 'Quantité reçu',
			'prix_unitaire' => 'Prix unitaire',
			'montant' => 'Mantant (FCFA)',
			'categorie_id' => 'Catégorie',
			'fournisseur_id' => 'Fournisseur',
			'date_livraison' => 'Date Livraison',
			'etat_livraison' => 'Etat de la livraison',
		],
	],
	...
	'liturgique' => [
		'title' => 'Planification liturgique',
		'fields' => [
	...
	'viergeMarie' => [
		'title' => 'Messe pour Vierge Marie',
		'fields' => [	
		],
	],

	'Oshoffa' => [
		'title' => 'Messe pour Papa Oshoffa',
		'fields' => [	
		],
	],
	...
	'recommandation_financiere' => [
		'title' => 'Recommandation financière',
		'fields' => [
	...
	'decharge' => [
		'title' => 'Décharge',
		'fields' => [
			'nom_receveur' => 'Nom du receveur',
			'date'         => 'Date d\'émission',
			'nom_donneur' => 'Nom du donneur',
