...
<div class="modal fade" id="fournisseur-info{{ $fournisseur->id }}">
    <div class="modal-dialog">
        <form method="POST" action="{{ route("user.fournisseur.update",$fournisseur->id)}}">
            @csrf
            @method("PUT")
            <div class="modal-content bg-info">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  name="libelle" value="{{$fournisseur->libelle }}" class="form-control" placeholder="" required>
                        </div>
                    ...
                    <div class="form-group row">
                      ...
                      <div class="col-sm-10">
                          <input type="text"  name="adresse" value="{{$fournisseur->adresse }}" class="form-control" placeholder="">
                      </div>
                      <p class="help-block"></p>
...
<div class="modal fade" id="fournisseur-danger{{$fournisseur->id }}">
    <div class="modal-dialog">
      <div class="modal-content bg-danger">
        ...
        <form  action="{{ route('user.fournisseur.destroy',$fournisseur->id) }}" method="POST">
            @csrf
            @method('DELETE')
            <div class="modal-body">
...
<div class="modal fade" id="fournisseur-default{{$fournisseur->id }}">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title"> Indormation sur  {{$fournisseur->title }}</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
                  ...
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text"  name="name" value="{{$fournisseur->title }}" class="form-control" placeholder="" disabled>
                            </div>
                        </div>
