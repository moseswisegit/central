                                ...
                                <div class="panel @if($plan->id == $user_role) panel-success @endif">
                                    ...
                                    <div class="panel-footer text-center">
                                        @unless($plan->id == $user_role)
                                            {{ Form::open(['route' => ['superAdmin.subscriptions.update', $plan->id], 'method' => 'PUT', 'id' => 'role-' . $plan->id]) }}
                                            <script
                                            ...
                                            {{ Form::close() }}
                                            @else
                                                {{ Form::open(['route' => ['superAdmin.subscriptions.destroy', $plan->id], 'method' => 'DELETE', 'id' => 'role-' . $plan->id]) }}
