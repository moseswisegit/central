 ...
 <div class="modal fade" id="modal-primary">
    ...
    <div class="modal-content bg-primary">
        <form class="form-horizontal" method="POST" action="{{ route("superAdmin.folders.store")}}">
            @csrf
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="name" class="col-sm-2 col-form-label">{{trans('quickadmin.folders.fields.name').'*'}}</label>
                        <div class="col-sm-10">
