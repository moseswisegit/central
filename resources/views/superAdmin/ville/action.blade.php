...
<div class="modal fade" id="ville-info{{ $item->id }}">
    <div class="modal-dialog">
        <form method="POST" action="{{ route("superAdmin.ville.update",$item->id)}}">
            @csrf
            @method("PUT")
                    ...
                    <div class="form-group row">
                      ...
                      <select name="pays_id" class="form-control col-sm-10" required>
                          ...
                          @foreach($pays as $itemPays)
                            <option value="{{ $itemPays->id }}" {{ $item->pays_id == $itemPays->id ? 'selected' : '' }}>
                                {{ $itemPays->libelle }}
                            </option>
                          @endforeach
                      </select>
...
<div class="modal fade" id="ville-danger{{$item->id }}">
    <div class="modal-dialog">
      <div class="modal-content bg-danger">
        ...
        <form  action="{{ route('superAdmin.ville.destroy',$item->id) }}" method="POST">
            @csrf
            @method('DELETE')
            <div class="modal-body">
...
<div class="modal fade" id="ville-default{{$item->id }}">
    <div class="modal-dialog">
                ...
                <div class="position-relative p-3 bg-white" style="height: 180px">
                  ...
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <div class="form-group row">
                            <label for="name" class="col-sm-4 col-form-label">{{trans('quickadmin.ville.fields.libelle')}}</label>
                            <div class="col-sm-8">
