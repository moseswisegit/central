...
<div class="modal fade" id="pays-info{{ $item->id }}">
    <div class="modal-dialog">
        <form method="POST" action="{{ route("superAdmin.pays.update",$item->id)}}">
            @csrf
            @method("PUT")
...
<div class="modal fade" id="pays-danger{{$item->id }}">
    <div class="modal-dialog">
      <div class="modal-content bg-danger">
        ...
        <form  action="{{ route('superAdmin.pays.destroy',$item->id) }}" method="POST">
            @csrf
            @method('DELETE')
            <div class="modal-body">
...
<div class="modal fade" id="pays-default{{$item->id }}">
    <div class="modal-dialog">
                ...
                <div class="position-relative p-3 bg-white" style="height: 180px">
                  ...
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <div class="form-group row">
                            <label for="name" class="col-sm-4 col-form-label">{{trans('quickadmin.pays.fields.libelle')}}</label>
                            <div class="col-sm-8">
