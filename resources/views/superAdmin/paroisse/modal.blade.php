 {{-- modal --}}
 <div class="modal fade" id="paroisse-primary">
    <div class="modal-dialog">
    <div class="modal-content bg-primary">
        <form class="form-horizontal" method="POST" action="{{ route("superAdmin.paroisse.store")}}">
            @csrf
            ...
            <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="libelle" class="col-sm-2 col-form-label">{{trans('quickuser.paroisse.fields.libelle').'*'}}</label>
                        <div class="col-sm-10">
