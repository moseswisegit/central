...
<div class="modal fade" id="commune-info{{ $item->id }}">
    <div class="modal-dialog">
        <form method="POST" action="{{ route("superAdmin.commune.update",$item->id)}}">
            @csrf
            @method("PUT")
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                      ...
                      <select name="ville_id" class="form-control col-sm-10" required>
                          ...
                          @foreach($ville as $itemVille)
                            <option value="{{ $itemVille->id }}" {{ $item->ville_id == $itemVille->id ? 'selected' : '' }}>
                                {{ $itemVille->libelle }}
                            </option>
                          @endforeach
                      </select>
...
<div class="modal fade" id="commune-danger{{$item->id }}">
    <div class="modal-dialog">
      <div class="modal-content bg-danger">
        ...
        <form  action="{{ route('superAdmin.commune.destroy',$item->id) }}" method="POST">
            @csrf
            @method('DELETE')
            <div class="modal-body">
...
<div class="modal fade" id="commune-default{{$item->id }}">
    <div class="modal-dialog">
                ...
                <div class="position-relative p-3 bg-white" style="height: 180px">
                  ...
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <div class="form-group row">
                            <label for="name" class="col-sm-4 col-form-label">{{trans('quickadmin.commune.fields.libelle')}}</label>
                            <div class="col-sm-8">
