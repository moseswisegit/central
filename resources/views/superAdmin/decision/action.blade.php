...
<div class="modal fade" id="decision-info{{ $item->id }}">
    <div class="modal-dialog">
        <form method="POST" action="{{ route("superAdmin.decision.update",$item->id)}}">
            @csrf
            @method("PUT")
            <div class="modal-content bg-info">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        <label for="libelle" class="col-sm-2 col-form-label">{{trans('quickadmin.decision.fields.libelle').'*'}}</label>
                        <div class="col-sm-10">
...
<div class="modal fade" id="decision-danger{{$item->id }}">
    <div class="modal-dialog">
      <div class="modal-content bg-danger">
        ...
        <form  action="{{ route('superAdmin.decision.destroy',$item->id) }}" method="POST">
            @csrf
            @method('DELETE')
            <div class="modal-body">
...
<div class="modal fade" id="decision-default{{$item->id }}">
    <div class="modal-dialog">
                ...
                <div class="position-relative p-3 bg-white" style="height: 180px">
                  ...
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <div class="form-group row">
                            <label for="name" class="col-sm-4 col-form-label">{{trans('quickadmin.decision.fields.libelle')}}</label>
                            <div class="col-sm-8">
