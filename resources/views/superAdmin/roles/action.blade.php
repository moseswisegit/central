...
<div class="modal fade" id="role-info{{ $role->id }}">
            ...
            <div class="modal-content bg-info">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                            <input type="text"  name="title" value="{{$role->title }}" class="form-control" placeholder="" required>
                        </div>
...
<div class="modal fade" id="role-danger{{$role->id }}">
    <div class="modal-dialog">
...
<div class="modal fade" id="role-default{{$role->id }}">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title"> Indormation sur  {{$role->title }}</h4>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
                  ...
                  <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <div class="form-group row">
                            <label for="name" class="col-sm-2 col-form-label">{{trans('quickadmin.users.fields.name')}}</label>
                            <div class="col-sm-8">
                                <input type="text"  name="name" value="{{$role->title }}" class="form-control" placeholder="" disabled>
                            </div>
                        </div>
