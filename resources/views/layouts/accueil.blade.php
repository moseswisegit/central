...
<head>
  ...
  <!-- Favicons -->
  <link href="{{('Accueil/assets/img/favicon.png')}}" rel="icon">
  <link href="{{('Accueil/assets/img/apple-touch-icon.png')}}" rel="apple-touch-icon">
...
<body>
  ...
  <script src="{{asset('Accueil/assets/vendor/waypoints/noframework.waypoints.js')}}"></script>
