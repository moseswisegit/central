...
class FoldersController extends Controller
{
    ...
    public function index()
    {
        ...
        $enteteContent = "Dossiers";


        return view('SuperAdmin.folders.index', compact('folders','enteteContent'));
    }
    ...
    public function create()
    {
        ...
        return view('SuperAdmin.folders.create', compact('created_bies'));
    }
    ...
    public function store(StoreFoldersRequest $request)
    {
        ...
        return redirect()->route('superAdmin.folders.index');
    }
    ...
    public function edit($id)
    {
        ...
        return view('SuperAdmin.folders.edit', compact('folder', 'created_bies'));
    }
    ...
    public function show($id)
    {
        ...
        return view('SuperAdmin.folders.show', compact('folder', 'files', 'userFilesCount'));
    }
